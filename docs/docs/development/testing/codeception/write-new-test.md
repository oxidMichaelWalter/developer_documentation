...
## Example module {#codeception_example_module}
...
## Creating test structure in a module {#codeception_initialization}
...
our current case `<tests_folder>/Codeception`), a configuration file `codeception.yml` and default
acceptance test suite `Acceptance.suite.yml`.

For quick Codeception info please refer to the
[Codeception documentation](https://codeception.com/docs/GettingStarted).
...
- [OXID eShop Module Template](https://github.com/OXID-eSales/module-template)
