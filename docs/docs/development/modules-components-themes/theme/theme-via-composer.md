...
Install themes via Composer by using [OXID eShop Composer Plugin](https://github.com/OXID-eSales/oxideshop_composer_plugin).

To install theme correctly, this plugin requires two fields to be described in the `composer.json` file:

- [type](#type)
- [extra](#extra-oxideshop)
...
`target-directory` value will be used to create a folder inside the Shop `Application/views` directory. This folder will be used to place all files of the module.
