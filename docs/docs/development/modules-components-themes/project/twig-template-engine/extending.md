...
- The first one is to simply [add extension to Twig environment](https://twig.symfony.com/doc/2.x/advanced.html#overloading).
- The other way is to override extension service of the [OXID eShop twig component](https://github.com/OXID-eSales/twig-component).
