...
To access admin panel please install [the Twig theme for the admin area](https://github.com/OXID-eSales/twig-admin-theme):
...
To access shop's frontend, please install [OXID's default Twig theme for the frontend area](https://github.com/OXID-eSales/apex-theme):
...
:::note
See [OXID Developer Tools component](https://github.com/OXID-eSales/developer-tools) if the above command's not available.
:::
