...
:::note
Watch a short video tutorial on YouTube: [Active Records](https://www.youtube.com/watch?v=JSOlVnMcgSs).
:::
...
:::note
Watch a short video tutorial on YouTube: [SQL Statements with the Query Builder](https://www.youtube.com/watch?v=i1_omW8iXJE).
:::
...
Now all types of SQL queries can be generated, based on the [Doctrine DBAL Documentation](https://www.doctrine-project.org/projects/doctrine-dbal/en/2.5/reference/query-builder.html#sql-query-builder).
