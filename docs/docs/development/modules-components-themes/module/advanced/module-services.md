...
[Symfony DI Container documentation](https://symfony.com/doc/current/components/dependency_injection.html)
...
:::note
**class** argument in **services.yaml** is optional and can be omitted
